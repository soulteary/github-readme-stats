...
// LanguageColors maps programming language names to their hex color codes
...
// GetLanguageColor returns the color for a given programming language
// Returns default color "#858585" if language not found
func GetLanguageColor(languageName string) string {
	if color, ok := LanguageColors[languageName]; ok {
		return color
	}
	return "#858585" // Default color
}
